/* eslint-disable */
import { defaultValue, TextureWrap, PixelFormat, destroyObject, ShadowMode } from 'cesium'
    function DDSTexture(context, id, source) {
        ...
        this._wrapS = defaultValue(source.wrapS, TextureWrap.CLAMP_TO_EDGE);
        this._wrapT = defaultValue(source.wrapT, TextureWrap.CLAMP_TO_EDGE);
        this.id = id;
